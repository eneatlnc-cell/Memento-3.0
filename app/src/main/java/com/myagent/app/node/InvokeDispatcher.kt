package com.myagent.app.node

import com.myagent.app.gateway.GatewaySession
import com.myagent.app.protocol.OpenClawCalendarCommand
import com.myagent.app.protocol.OpenClawCallLogCommand
import com.myagent.app.protocol.OpenClawCameraCommand
import com.myagent.app.protocol.OpenClawCanvasA2UICommand
import com.myagent.app.protocol.OpenClawCanvasCommand
import com.myagent.app.protocol.OpenClawContactsCommand
import com.myagent.app.protocol.OpenClawDeviceCommand
import com.myagent.app.protocol.OpenClawLocationCommand
import com.myagent.app.protocol.OpenClawMotionCommand
import com.myagent.app.protocol.OpenClawNotificationsCommand
import com.myagent.app.protocol.OpenClawSmsCommand
import com.myagent.app.protocol.OpenClawSystemCommand
import com.myagent.app.protocol.OpenClawTalkCommand
...
class InvokeDispatcher(
  ...
  suspend fun handleInvoke(
    ...
    return when (command) {
      ...
      // Photos command
      com.myagent.app.protocol.OpenClawPhotosCommand.Latest.rawValue ->
