...
import com.myagent.app.GatewayDeviceTokenSummary
import com.myagent.app.GatewayNodeApprovalState
import com.myagent.app.GatewayNodeSummary
import com.myagent.app.GatewayNodesDevicesSummary
import com.myagent.app.GatewayPairedDeviceSummary
import com.myagent.app.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "灵机 $it" }
